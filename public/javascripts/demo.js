...
function getBeneficiariesOverTime() {
        ...
        function (res) {
            if (res.status) {
                res.data.forEach(el => {
                    ...
                    selectedMonths.push(months[date.getMonth() - 1])
                    monthValue.push(el.beneficiary_sum.value)
                })
            ...
            function (res) {
                ...
                if (res.status) {
                    res.data.forEach(el => {
                        ...
                        var date = new Date(el.key)
                        selectedMonths.push(months[date.getMonth() - 1])
                        monthValue.push(el.spending_sum.value)
                    })
                    ...
                    var dailySalesChart = new Chartist.Line('#emailsSubscriptionChart', dataDailySalesChart, optionsDailySalesChart);
                ...
                function (res) {
                    ...
                    if (res.status) {
                        res.data.forEach(el => {
                            ...
                            var date = new Date(el.key)
                            selectedMonths.push(months[date.getMonth() - 1])
                            monthValue.push(el.volunteers_count.value)
                        })
                        ...
                        var emailsSubscriptionChart = Chartist.Bar('#dailySalesChart', dataEmailsSubscriptionChart, optionsEmailsSubscriptionChart, responsiveOptions);
