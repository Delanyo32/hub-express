...
var EventReplayer = /** @class */ (function () {
    ...
    function (prebootData) {
        ...
        if (typeof CustomEvent === 'function') {
            var /** @type {?} */ completeEvent = new CustomEvent('PrebootComplete');
 ...
 * @suppress {checkTypes} checked by tsc
 */
var PREBOOT_SCRIPT_ID = 'preboot-inline-script';
...
function PREBOOT_FACTORY(doc, prebootOpts, nonce, platformId, appRef, eventReplayer) {
    return function () {
        if (isPlatformServer(platformId)) {
            var /** @type {?} */ inlineCode = getInlinePrebootCode(prebootOpts);
            ...
            var /** @type {?} */ existingScripts = doc.querySelectorAll("#" + PREBOOT_SCRIPT_ID);
        ...
        if (isPlatformBrowser(platformId)) {
            var /** @type {?} */ replay = prebootOpts.replay != null ? prebootOpts.replay : true;
            if (replay) {
                appRef.isStable
